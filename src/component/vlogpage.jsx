...
function VlogPage() {
    const [vlogs, setVlogs] = useState([
        // Original 17 vlogs
        {
            ...
            fullDesc: "Smart irrigation uses IoT sensors, drip systems, and AI-based monitoring to save water and increase yields.",
            thumbnail: "https://images.unsplash.com/photo-1600456899122-d2ecf2fa0a6f?auto=format&fit=crop&w=600&q=80",
            likes: 0,
            dislikes: 0,
            userVote: null,
        },
        {
            ...
            fullDesc: "Organic farming avoids harmful chemicals, promotes biodiversity, and enhances soil fertility.",
            thumbnail: "https://images.unsplash.com/photo-1615485294145-4c759ee9d94f?auto=format&fit=crop&w=600&q=80",
            likes: 0,
            dislikes: 0,
            userVote: null,
        },
        ...
        },
        {
            ...
            author: "Dr. Shahariar Islam Rafi",
            fullDesc: "Discover eco-friendly ways to control pests without chemicals.",
            thumbnail: "https://images.unsplash.com/photo-1501004318641-b39e6451bec6?auto=format&fit=crop&w=600&q=80",
            likes: 0,
            dislikes: 0,
            userVote: null,
        },
        {
            ...
            author: "Dr. Arafat Rahman",
            fullDesc: "Techniques to collect and store rainwater for irrigation and sustainability.",
        ...
        },
        {
            ...
            thumbnail: "https://images.unsplash.com/photo-1581091870620-9c4d89a7a6f1?auto=format&fit=crop&w=600&q=80",
            likes: 0,
            dislikes: 0,
            userVote: null,
        },
        {
            ...
            author: "Dr. Arafat Rahman",
            fullDesc: "Combine crops, livestock, and fish farming for sustainable yield.",
            thumbnail: "https://images.unsplash.com/photo-1598514983883-cdfb69f1bc32?auto=format&fit=crop&w=600&q=80",
            likes: 0,
            dislikes: 0,
            userVote: null,
        },
        {
            ...
            author: "Dr. Shahariar Islam Rafi",
            fullDesc: "Using solar energy to power irrigation pumps and farm machinery.",
            thumbnail: "https://images.unsplash.com/photo-1615485294145-4c759ee9d94f?auto=format&fit=crop&w=600&q=80",
            likes: 0,
            dislikes: 0,
            userVote: null,
        },
        {
            ...
            author: "Dr. Arafat Rahman",
            fullDesc: "Convert farm waste into compost and bio-energy for a zero-waste farm.",
            thumbnail: "https://images.unsplash.com/photo-1581094655367-3e7b3a0a98a1?auto=format&fit=crop&w=600&q=80",
            likes: 0,
            dislikes: 0,
            userVote: null,
        },
        {
            ...
            author: "Dr. Shahariar Islam Rafi",
            fullDesc: "Adapt farming methods to mitigate the effects of climate change.",
            thumbnail: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?auto=format&fit=crop&w=600&q=80",
            likes: 0,
            dislikes: 0,
            userVote: null,
            ...
            <div className="flex flex-col lg:flex-row gap-6 mb-6">
                <div className="lg:w-1/2">
                    ...
                    {showForm && (
                        ...
                        >
                            <h2 className="text-2xl font-bold text-lime-800 mb-4">✍ Upload a New Vlog</h2>
                            <input
                                type="text"
                                name="author"
                ...
                {filteredVlogs.map((vlog) => (
                    ...
                    >
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-sm text-lime-600 font-medium">By: {vlog.author}</p>
